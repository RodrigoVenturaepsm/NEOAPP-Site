                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row1['license_id']; ?></td>
                        <td><?php echo $row1['name_busdriver']; ?></td>
                        <td><?php echo $row1['phone_busdriver']; ?></td>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row2['license_id']; ?></td>
                        <td><?php echo $row2['name_busdriver']; ?></td>
                        <td><?php echo $row2['phone_busdriver']; ?></td>
